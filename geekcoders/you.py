...
main_menu=tk.Menu()
#file icons
new_icon=tk.PhotoImage(file='D:hari/new.png')
open_icon=tk.PhotoImage(file='D:/hari/open.png')
...
#edit icons
cut_icon=tk.PhotoImage(file='D:/hari/cut.png')
copy_icon=tk.PhotoImage(file='D:/hari/copy.png')
paste_icon=tk.PhotoImage(file='D:/hari/paste.png')
clear_icon=tk.PhotoImage(file='D:/hari/clear.png')
find_icon=tk.PhotoImage(file='D:/hari/find.png')

edit=tk.Menu(main_menu, tearoff=False)


##view icons
toolbar_icon=tk.PhotoImage(file="D:/hari/toolbar.png")
statusbar_icon=tk.PhotoImage(file="D:/hari/statusbar.png")
view=tk.Menu(main_menu, tearoff=False)



####color theme
light_def_icon=tk.PhotoImage(file='D:/hari/light_default.png')
light_pl_icon=tk.PhotoImage(file='D:/hari/light_plus.png')
dark_icon=tk.PhotoImage(file='D:/hari/dark.png')
red_icon=tk.PhotoImage(file='D:/hari/red.png')
mono_icon=tk.PhotoImage(file='D:/hari/monokai.png')
night_icon=tk.PhotoImage(file='D:/hari/night_blue.png')
color_theme=tk.Menu(main_menu, tearoff=False)

theme=tk.StringVar()
color_icon=(light_def_icon,light_pl_icon,dark_icon,red_icon,mono_icon,night_icon)
...
bold_icon=tk.PhotoImage(file='D:/hari/bold.png')
bold_btn=ttk.Button(tool_bar,image=bold_icon,)
bold_btn.grid(row=0,column=2,padx=5)

#italic button
italic_icon=tk.PhotoImage(file='D:/hari/italic.png')
italic_btn=ttk.Button(tool_bar,image=italic_icon)
italic_btn.grid(row=0,column=3,padx=5)

#underline btn
underline_icon=tk.PhotoImage(file='D:/hari/underline.png')
underline_btn=ttk.Button(tool_bar,image=underline_icon)
underline_btn.grid(row=0,column=4,padx=5)

#font btn
font_icon=tk.PhotoImage(file='D:/hari/font.png')
font_btn=ttk.Button(tool_bar,image=font_icon )
font_btn.grid(row=0,column=5,padx=5)

#align btns
left_icon=tk.PhotoImage(file='D:/hari/align_left.png')
left_align=ttk.Button(tool_bar,image=left_icon)
left_align.grid(row=0,column=6,padx=5)

center_icon=tk.PhotoImage(file='D:/hari/align_center.png')
center_btn=ttk.Button(tool_bar,image=center_icon)
center_btn.grid(row=0,column=7,padx=5)


right_icon=tk.PhotoImage(file='D:/hari/align_right.png')
...
#### underline_button functionality
...
left_align.configure(command=align_left)
...
center_btn.configure(command=align_cent)
...
right_btn.configure(command=align_rigt)
    ...
    def find():
        ...
        if word:
            ...
            while True:
                ...
                matches+=1
                start_pos=end_pos
                text_editor.tag_config('match',foreground='yellow',background='purple')    
...
count=0
for i in color_dict:
    color_theme.add_radiobutton(label=i,image=color_icon[count],variable=theme,compound=tk.LEFT,command=change_theme)
    count+=1
